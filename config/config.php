...
require '/etc/elixir-proxy/config.php';
...
$config = array(
     ...
     */
    'technicalcontact_name' => 'ELIXIR AAI',
    'technicalcontact_email' => 'mailto:aai-contact@elixir-europe.org',
    ...
    'metadata.sources' => array(
        array('type' => 'flatfile'),
        array('type' => 'flatfile', 'directory' => 'metadata/metadata-edugain'),
    ),
     ...
     */
    'trusted.url.domains' => array('www.elixir-europe.org', 'perun.elixir-czech.cz'),
