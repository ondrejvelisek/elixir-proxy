...
$this->data['head'] .= '<script src="' . SimpleSAML_Module::getModuleUrl('elixir/res/js/jquery.js')  . '" ></script>';
$this->data['head'] .= '<script src="' . SimpleSAML_Module::getModuleUrl('elixir/res/bootstrap/js/bootstrap.min.js')  . '" ></script>';
